...
//	       2. Verify the login button text is capitalized
		...
		Assert.assertTrue(loginInUpperCase.equalsIgnoreCase(loginpage.getLoginButtonText()),
				"LOGIN is not Capitalized");
...
//	       4. Verify default filter dropdown is A-Z
		...
		Assert.assertTrue(filterOption.equalsIgnoreCase(productspage.getDefaultFilterDropdownOptionValue()),
				"Default filter value is " + productspage.getDefaultFilterDropdownOptionValue());
...
//	       6. Verify the cart badge has 1 product
		...
		Assert.assertTrue("1".equalsIgnoreCase(productspage.shoppinfCartIcon.getText().toString()),
				"Shopping cart value is not 1");
...
//	       8. Verify the cart badge value is increased
		...
		System.out.println("Shopping Cart count: " + productspage.shoppinfCartIcon.getText());
		Assert.assertTrue("2".equalsIgnoreCase(productspage.shoppinfCartIcon.getText().toString()),
				"Shopping cart value is not 2");
...
//		   14. Change the price filter from low to high
		System.out.println("//Change the price filter from low to high");
		Thread.sleep(2000);
		...
		Assert.assertTrue("Price (low to high)".equalsIgnoreCase(productspage.getDefaultFilterDropdownOptionValue()),
				"Changed filter value is " + productspage.getDefaultFilterDropdownOptionValue());
