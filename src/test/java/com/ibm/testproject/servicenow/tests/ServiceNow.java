...
//			   12. Verify the title as ServiceNow
	...
	@Test
	public void testServiceNowLoginNegative() throws Exception {
...
//		   4. Verify the error message as Invalid input in user name!
		System.out.println("//Verify the error message as Invalid input in user name!");
		System.out.println("Print Error Message: " + loginpage.invalidUsrnameMessage.getText());
		String expectedInvlidUsernameMessage = "Invalid input in user name!";
		Assert.assertTrue(expectedInvlidUsernameMessage.equalsIgnoreCase(loginpage.invalidUsrnameMessage.getText()),
...
//		   7. Verify the error message contains User name or password invalid
		System.out.println("//Verify the error message contains User name or password invalid");
		System.out.println("Print Error Message: " + loginpage.invalidUserNameOrPasswordMessage.getText());
		Assert.assertTrue(
				loginpage.invalidUserNameOrPasswordMessage.getText().contains("User name or password invalid"),
				"Error message not displayed correctly!");
